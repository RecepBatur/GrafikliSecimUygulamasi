...
namespace PartiSecimUygulamasi
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=RECEP;Initial Catalog=DbSecim;Integrated Security=True");
        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand ilce = new SqlCommand("Select ILCEAD from TBLILCE",baglanti);
            ...
            SqlCommand sonuc = new SqlCommand("Select SUM(APARTI),SUM(BPARTI),SUM(CPARTI),SUM(DPARTI),SUM(EPARTI) FROM TBLILCE",baglanti);
            SqlDataReader dr2 = sonuc.ExecuteReader();
            while (dr2.Read())
            {
